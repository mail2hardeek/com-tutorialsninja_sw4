...
public class LoginTest extends BaseTest {
    ...
    public void registerAccountAndLogin() {
        ...
        registerPage.sendLastName("Test");                                                                                      //Enter Last Name
        registerPage.sendEmail("Prime99@gmail.com");                                                                           //Enter Email
        registerPage.sendTelephone("02089022311");                                                                                //Enter Telephone
        registerPage.sendPassword("Prime12test");                                                                                     //Enter Password
        registerPage.sendConfirmPassword("Prime12test");                                                                              //Enter Password Confirm
    ...
    public void loginAccount() {
        ...
        loginLink.enterEmail("Prime99@gmail.com");
        loginLink.enterPassword("Prime12test");
    ...
    public void laptopsAndNotebooks() {
        ...
        checkOutPage.sendName("Harry");                                                                                                //Fill the mandatory name field
        checkOutPage.sendLastName("VD");                                                                                             //Fill the mandatory surname field
        checkOutPage.sendEmail("Prime99@gmail.com");                                                                                 //Fill the mandatory email field
        checkOutPage.sendTelephone("02089022311");                                                                                     //Fill the mandatory phone field
        checkOutPage.sendAddress("Union Hall");                                                                                  //Fill the mandatory address field
        checkOutPage.sendCity("London");                                                                                               //Fill the mandatory city field
        checkOutPage.sendPostCode("HA0 4SE");                                                                                         //Fill the mandatory postcode field
        checkOutPage.enterRegion("Middex");                                                                                   //Fill the mandatory payzone field
